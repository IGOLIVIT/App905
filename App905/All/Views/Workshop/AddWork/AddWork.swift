                    ...
                    ZStack {
                        ...
                        HStack {
                            ...
                            Button(action: {
                                ...
                                viewModel.woTool1 = viewModel.currentImage1
                                viewModel.woTool2 = viewModel.currentImage2
                                viewModel.woTool3 = viewModel.currentImage3
                                viewModel.woCat = viewModel.currentCategory
                                viewModel.woType = viewModel.currentType
                            ...
                            .opacity(viewModel.woTitle.isEmpty || viewModel.woDescr.isEmpty || viewModel.currentCategory.isEmpty ? 0.5 : 1)
                            .disabled(viewModel.woTitle.isEmpty || viewModel.woDescr.isEmpty || viewModel.currentCategory.isEmpty ? true : false)
                        }
                    }
                }
                .padding()
                        ...
                        HStack {
                            ...
                            ZStack(content: {
                                ...
                                Text("Text")
                                    ...
                                    .opacity(viewModel.woTitle.isEmpty ? 1 : 0)
                                    .frame(maxWidth: .infinity, alignment: .leading)
                                
                                TextField("", text: $viewModel.woTitle)
                                    .foregroundColor(Color.black)
                                    .font(.system(size: 16, weight: .medium))
                        ...
                        HStack {
                            ...
                            ZStack(content: {
                                ...
                                Text("Text")
                                    .foregroundColor(.gray.opacity(0.5))
                                    .font(.system(size: 14, weight: .regular))
                                    .opacity(viewModel.woDescr.isEmpty ? 1 : 0)
                                    .frame(maxWidth: .infinity, alignment: .leading)
                                
                                TextField("", text: $viewModel.woDescr)
                                    .foregroundColor(Color.black)
                                    .font(.system(size: 16, weight: .medium))
...
#Preview {
    AddWork(viewModel: WorkshopViewModel())
}
